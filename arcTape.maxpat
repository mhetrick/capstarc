...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 535.0, 70.0, 17.0 ],
					"style" : "",
					"text" : "r sampleLoaded"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.0, 525.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "r scrub"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 300.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "s scrub"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 224.0, 335.0, 44.0, 47.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 224.0, 396.0, 35.0, 22.0 ],
					"style" : "",
					"text" : "* 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 194.0, 562.0, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"loopend" : [ 3506.285645, "ms" ],
						"loopstart" : [ 27.827665, "ms" ],
						"mode" : "basic",
